...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define LCD_FRAMEBUFFER_ADDR 0xD0000000
...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOE,
                    MatrixA4_Pin | MatrixA3_Pin | MatrixA2_Pin | MatrixA1_Pin |
                        MatrixA0_Pin,
                    GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MatrixA7_Pin | MatrixA6_Pin | MatrixA5_Pin,
                    GPIO_PIN_RESET);

  /*Configure GPIO pins : MatrixA4_Pin MatrixA3_Pin MatrixA2_Pin MatrixA1_Pin
                           MatrixA0_Pin */
  GPIO_InitStruct.Pin =
      MatrixA4_Pin | MatrixA3_Pin | MatrixA2_Pin | MatrixA1_Pin | MatrixA0_Pin;
  ...
  /*Configure GPIO pins : MatrixB5_Pin MatrixB4_Pin MatrixB3_Pin */
  GPIO_InitStruct.Pin = MatrixB5_Pin | MatrixB4_Pin | MatrixB3_Pin;
  ...
  /*Configure GPIO pin : MatrixB6_Pin */
  GPIO_InitStruct.Pin = MatrixB6_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(MatrixB6_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : MatrixB7_Pin MatrixB8_Pin MatrixB1_Pin */
  GPIO_InitStruct.Pin = MatrixB7_Pin | MatrixB8_Pin | MatrixB1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : MatrixB2_Pin */
  GPIO_InitStruct.Pin = MatrixB2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(MatrixB2_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : MatrixA7_Pin MatrixA6_Pin MatrixA5_Pin */
  GPIO_InitStruct.Pin = MatrixA7_Pin | MatrixA6_Pin | MatrixA5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
/**
 * @brief Retargets printf to USART1 for debug output.
 */
...
/**
 * @brief  Default task — initialises hardware, LVGL, and drives the UI render
 * loop.
...
void StartDefaultTask(void const *argument) {
  ...
  /* Initialise external SDRAM - required before framebuffer use */
  BSP_SDRAM_Init();
