...
**P33 — MODE screen unimplemented rows** — Rows 1/4/5/6/7 complete. Remaining: Row 8 (`Real | Polar | Param`) gates further graphing subsystems. Spec: `docs/MENU_SPECS.md` lines 25–43.
