...
**P33 — MODE screen unimplemented rows** — Rows 1/4/5/7 complete. Remaining: Rows 6/8 (`Sequential | Simul`, `Real | Polar | Param`) gate further graphing subsystems. Spec: `docs/MENU_SPECS.md` lines 25–43.
